...
export class UserService {
  ...
  load(pagination?: Pagination) {
    ...
    return this.backendService.load<UserDTO>(this.basePath, pagination)
  ...
  get(id: string) {
    ...
    return this.backendService
      .getById<UserDTO>(this.basePath, id);
  }
  ...
  add(userToAdd: User | UserDTO) {
    ...
    return this.backendService.push<UserDTO>(
      this.basePath, body
    );
  }
  ...
  update(user: User) {
    ...
    return this.backendService.set<UserDTO>(
